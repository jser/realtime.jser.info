---
title: Node.js 21 is now available! | Node.js
author: azu
layout: post
itemUrl: 'https://nodejs.org/en/blog/announcements/v21-release-announce'
editJSONPath: 'https://github.com/jser/jser.info/edit/gh-pages/data/2023/10/index.json'
date: '2023-10-25T13:17:45Z'
tags:
  - nodejs
  - ReleaseNote
relatedLinks:
  - title: Node v21.0.0 (Current) | Node.js
    url: 'https://nodejs.org/en/blog/release/v21.0.0'
---
Node.js v21リリース。
