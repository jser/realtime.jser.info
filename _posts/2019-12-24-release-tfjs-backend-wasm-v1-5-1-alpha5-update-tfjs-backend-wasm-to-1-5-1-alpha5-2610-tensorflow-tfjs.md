---
title: >-
  Release tfjs-backend-wasm-v1.5.1-alpha5: Update tfjs-backend-wasm to
  1.5.1-alpha5. (#2610) · tensorflow/tfjs
author: azu
layout: post
itemUrl: >-
  https://github.com/tensorflow/tfjs/releases/tag/tfjs-backend-wasm-v1.5.1-alpha5
editJSONPath: 'https://github.com/jser/jser.info/edit/gh-pages/data/2019/12/index.json'
date: '2019-12-24T23:06:29Z'
tags:
  - JavaScript
  - WebAssembly
  - library
